...
dirSwitch?.addEventListener("change", (e) => {
  ...
  if (checkbox.checked) {
    ...
    rtlLink.href = "assets/fuzzy/css/vendors/bootstrap.rtl.min.css";
    localStorage.setItem("rtlcss", "assets/fuzzy/css/vendors/bootstrap.rtl.min.css");
    localStorage.setItem("dir", "rtl");
  }

  if (!checkbox.checked) {
    htmlDom.setAttribute("dir", "ltr");
    rtlLink.href = "assets/fuzzy/css/vendors/bootstrap.min.css";
    localStorage.setItem("rtlcss", "assets/fuzzy/css/vendors/bootstrap.min.css");
    localStorage.setItem("dir", "ltr");
  }
});
// Rtl
htmlDom.setAttribute("dir", localStorage.getItem("dir") ? localStorage.getItem("dir") : "ltr");
rtlLink.href = localStorage.getItem("rtlcss") ? localStorage.getItem("rtlcss") : "assets/fuzzy/css/vendors/bootstrap.min.css";
